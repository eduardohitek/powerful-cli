...
func randonTaskName(t *testing.T) string {
	t.Helper()
...
func TestIntegration(t *testing.T) {
	...
	t.Run("AddTask", func(t *testing.T) {
		...
		err := addAction(&out, apiRoot, args)
		if err != nil {
	...
	vRes := t.Run("ViewTask", func(t *testing.T) {
		var out bytes.Buffer
		err := viewAction(&out, apiRoot, taskId)
		if err != nil {
			t.Fatalf("Expected no error, got %q.", err)
		}
	...
	t.Run("CompleteTask", func(t *testing.T) {
		var out bytes.Buffer
		err := completeAction(&out, apiRoot, taskId)
		if err != nil {
			t.Fatalf("Expected no error, got %q.", err)
		}
	...
	t.Run("DeleteTask", func(t *testing.T) {
		var out bytes.Buffer
		err := delAction(&out, apiRoot, taskId)
		if err != nil {
			t.Fatalf("Expected no error, got %q.", err)
		}
